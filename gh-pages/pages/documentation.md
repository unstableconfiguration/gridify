...
## generated HTML 
The HTML generated by gridify is intended to be simple and easy to navigate or interact with programmatically. 
```
let htmlDemo = document.getElementById('html-demo');
let grid = new Gridify({
    container : 'html-demo',
    columns : [
       { field : 'col', header : 'col head', footer : 'col footer' }
    ],
    data : [ 
        { col : 1 }, 
        { col : 2 } 
    ],
    style: 'border-top:solid thin #555; border-bottom: solid thin #555'
});
